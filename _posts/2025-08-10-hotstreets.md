...
**Description:**  
This lab demonstrates the risks of exposing sensitive information in client-side code and using weak authentication mechanisms. The goal was to access the administrator panel and retrieve the hidden flag. <img src="/assets/images/H4k-IT/WEB/hotstreet1.png" alt="One" style="max-width:100%; height:auto;">
...
<img src="/assets/images/H4k-IT/WEB/hotstreet3.png" alt="Web" style="max-width:100%; height:auto;">
**Finding:** Inside the HTML comments, I found hardcoded **username** and **password**.
<img src="/assets/images/H4k-IT/WEB/hotstreet4.png" alt="Web" style="max-width:100%; height:auto;">

### 2. Post-Login Exploration
Once logged in, I navigated through the **dashboard**. 
<img src="/assets/images/H4k-IT/WEB/hotstreet5.png" alt="Task One" style="max-width:100%; height:auto;">
Viewing the **page source** again revealed another HTML comment. This time, it contained the **flag**.
<img src="/assets/images/H4k-IT/WEB/hotstreet6.png" alt="Task One" style="max-width:100%; height:auto;">
